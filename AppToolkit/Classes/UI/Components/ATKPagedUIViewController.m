...
#import "ATKPagedUIViewController.h"

#import "ATKSimpleStackView.h"

@interface ATKPagedUIViewController ()

@property (weak, nonatomic) IBOutlet UIScrollView *scrollView;
@property (weak, nonatomic) IBOutlet ATKSimpleStackView *pagesStackView;
@property (weak, nonatomic) IBOutlet UIButton *skipButton;
@property (strong, nonatomic) IBOutletCollection(UIPageControl) NSArray *pageControls;
@property (weak, nonatomic) IBOutlet ATKSimpleStackView *bottomStackView;
...
@implementation ATKPagedUIViewController
...
- (IBAction)onSkipButtonTriggered:(UIButton *)sender
{
    ...
    [self finishFlowWithResult:ATKViewControllerFlowResultCancelled userInfo:info];
}
