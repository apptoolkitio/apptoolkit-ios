...
#import "ATKSimpleStackView.h"

@interface ATKSimpleStackView ()
...
@implementation ATKSimpleStackView
...
{
    self.alignment = (alignmentValue == 1) ? ATKSimpleStackViewAlignmentCenter : ATKSimpleStackViewAlignmentFill;
...
{
    self.distribution = (distributionValue == 1) ? ATKSimpleStackViewDistributionFillEqually : ATKSimpleStackViewDistributionFill;
    [self setNeedsUpdateConstraints];
}
...
- (NSArray *)buildDistributionConstraintsForArrangedSubviews
{
    ...
    if (self.distribution == ATKSimpleStackViewDistributionFillEqually) {
        [self iterateVisibleArrangedSubviews:^(UIView *previous, UIView *current, BOOL *stop) {
    ...
    } else if (self.distribution == ATKSimpleStackViewDistributionFill) {
...
- (NSArray *)buildAlignmentConstraintsForArrangedSubviews
{
    ...
    [self iterateVisibleArrangedSubviews:^(UIView *previous, UIView *current, BOOL *stop) {
        ...
        if (current != nil) {
            if (self.alignment == ATKSimpleStackViewAlignmentCenter) {
